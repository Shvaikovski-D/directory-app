При генерации кода, используй следующие инструкции:
...
- Whenever possible, try to break the page component into smaller universal components for further use in other places.
